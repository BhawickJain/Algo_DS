...
It is interesting how the use of a higher order function can simplify and enable easier validation and optimisation. In the previous implementations of the method, 
