...
`[ ]` Create a `.findi` method that returns the index of the node that contains the specificied value in its `data` attribute.  
`[ ]` Create a `.iget` method that return the node object that sits at a given index.  
<!-- #endregion -->
